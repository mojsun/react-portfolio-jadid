        ...
        <div className={styles.body}>
          <div className={styles.description}>
            ...
            <div className="flex flex-row space-x-3 md:pb-8">
              <button className="btn border-t-neutral-800 text-white w-6/12 h-2/12  md:w-5/12 md:h-2/12">
                <a href={buttonLive}>Live</a>
              </button>
              <button className="btn border-t-neutral-700 text-white  w-6/12 h-2/12">
          ...
          <div className={styles.imageContainer}>
            <motion.div className={styles.inner} style={{ scale: imageScale }}>
              <img fill src={`/images/${src}`} alt="frontImage" />
            </motion.div>
          </div>
        </div>
        <div>
